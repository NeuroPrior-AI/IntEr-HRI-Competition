...
from models.resnet_model.resnet_predict import resnet_predict
...
def generate_prob_map(raw_fname, duration, precision, model_name, cla, tmin, tmax):
    ...
    for i in range(precision):
        ...
        if model_name == "ensemble":
            ...
            clf = load('models/ensemble.joblib')
            ...
            pred_prob_i = resnet_predict(X.reshape(X.shape[0], X.shape[1], X.shape[2]))[:, cla]
        else:
